...
const palavra = ['BIBLIOGRAFIA', 'DOCUMENTAÇÃO', 'ANATOMIAS', 'ESTUDOS' ,'OBRAS','DISSERTAÇÕES','ROTEIRO','MANUAIS','FUNDAMENTOS','MÉTODOS','RUDIMENTOS','COMPÊNDIOS','INDICADORES','COMPILAÇÕES', 'ERUDIÇÃO','INSTRUÇÃO','POETAS']
var click = false;
var escolha = [];
